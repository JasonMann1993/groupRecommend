...
//    'app_id' =>'wxecb839ffdf8a42ff',#测试授权
//    'secret' => 'be16002b76b6a4325049c676363c1393',#测试授权
...
//         'callback' => env('WECHAT_OAUTH_CALLBACK', url('api/app/callurl')),
     ],
    ...
    'payment' => [
        ...
        'cert_path'          => env('WECHAT_PAYMENT_CERT_PATH', storage_path('wechat/FirstIntegral/apiclient_cert.pem')), // XXX: 绝对路径！！！！
        'key_path'           => env('WECHAT_PAYMENT_KEY_PATH', storage_path('wechat/FirstIntegral/apiclient_key.pem')),      // XXX: 绝对路径！！！！

    ...
    <div>
        <el-form ref="form" :rules="rules" :model="post" label-width="100px" v-loading="pageLoading">
            ...
            <el-form-item label="发放数量" prop="total">
                <el-input type="number" v-model="post.total" placeholder=""></el-input>
            </el-form-item>
...
//                    {key: 1, value: '推荐'},
        ...
        methods: {
            ...
            getInfo() {
                ...
                this.$request.get(this.$url.shop.coupon.index + '/' + this.id).then(res => {
            ...
            onSubmit() {
                this.doValidate(() => {
                    ...
                    this.$request.put(this.$url.shop.coupon.index + '/' + this.id, this.post).then(res => {
            ...
            getMapKey() {
                this.$request.get(this.$url.shop.home.map_key).then(res => {

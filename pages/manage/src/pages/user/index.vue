        ...
        <div>
            ...
            <search :search="search" :load="doLoad">
                <el-form-item label="关键字" label-width="250">
                    <el-input v-model="search.keyword" placeholder="昵称/ID"></el-input>
                </el-form-item>
            </search>
                    ...
                    <el-table :data="lists" key="user" v-loading="loading">
                        ...
                        <el-table-column prop="avatar" label="头像">
                            <template slot-scope="scope">
                                <img :src="scope.row.avatar" alt="" class="user-avatar" width="50">
                            </template>
                        </el-table-column>
                        <el-table-column prop="type" label="用户身份"></el-table-column>
                        <el-table-column prop="group" label="所在群聊"></el-table-column>
                        ...
                        <el-table-column label="操作">
                            <template slot-scope="scope">
                                ...
                                <button-delete :url="$url.user.member + '/' + scope.row.id " @success="doLoad"></button-delete>
                            </template>
                        </el-table-column>
                    </el-table>
                </template>
    ...
    export default {
        ...
        methods: {
            ...
            getLists() {
                ...
                this.$request.get(this.$url.user.member, {params: this.search}).then(res => {
